...
public class ShiroConfiguration {
    ...
    /**
     * 自定义sessionManager，用户的唯一标示，即Token或Authorization的认证
     * @return
     */
    @Bean
    public SessionManager sessionManager(){
        //创建一个上面自定义的SessionManager
...
//        filterChainDefinitionMap.put("/user/info","anon");
    ...
    /**
     * 凭证匹配器（因为我们的密码校验交给Shiro的SimpleAuthenticationInfo进行处理了
     * @return
     */
    @Bean
